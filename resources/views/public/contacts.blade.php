...
<head>
    ...
    <title>Kontak dan Layanan - Perpustakaan Unand</title>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem;">
                    ...
                    <div
                        ...
                        <div style="text-align: center; margin-bottom: 2rem;">
                            <h2 style="font-size: 1.25rem; font-weight: 700; color: #B8985F; margin-bottom: 0.5rem;">
                                Kontak dan Layanan</h2>
                            <p style="color: #666; font-size: 0.875rem;">Layanan bantuan dan kontak resmi untuk
                                pertanyaan seputar peminjaman ruangan.</p>
                        </div>

                        {{-- Phone --}}
                        <div style="margin-bottom: 1.5rem;">
                            <div style="color: #B8985F; font-weight: 600; font-size: 0.875rem; margin-bottom: 0.5rem;">
                                Phone</div>
                        ...
                        <div>
                            ...
                            <div style="display: flex; align-items: flex-start; gap: 1rem;">
                                ...
                                <div>
                                    ...
                                    <div style="color: #666; font-size: 0.875rem;">{{ $contact->location_address }}
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div style="background: white; border: 1px solid #E5E7EB; border-radius: 12px; padding: 2rem;">
                        <div style="text-align: center; margin-bottom: 2rem;">
                            <h2 style="font-size: 1.25rem; font-weight: 700; color: #1a1a1a; margin-bottom: 0.5rem;">FAQ
                            </h2>
                        ...
                        <div style="display: flex; flex-direction: column; gap: 1rem;">
                            <div style="border: 1px solid #E5E7EB; border-radius: 8px; overflow: hidden;">
                                <button onclick="toggleFaq(this)"
                                    ...
                                    <span style="font-weight: 500; color: #374151;">Bagaimana cara meminjam
                                        ruangan?</span>
                                ...
                                <div class="faq-content"
                                    ...
                                    Anda dapat meminjam ruangan dengan login terlebih dahulu, kemudian mengakses menu
                                    Peminjaman.
                                </div>
                            </div>
                            ...
                            <div style="border: 1px solid #E5E7EB; border-radius: 8px; overflow: hidden;">
                                <button onclick="toggleFaq(this)"
                                    style="width: 100%; padding: 1rem; background: white; border: none; cursor: pointer; display: flex; justify-content: space-between; align-items: center; text-align: left;">
                                    <span style="font-weight: 500; color: #374151;">Berapa lama proses
                                        persetujuan?</span>
                                    <svg class="faq-arrow" width="20" height="20" fill="none" stroke="#9CA3AF"
                                        viewBox="0 0 24 24" style="transition: transform 0.3s;">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
