        ...
        <div style="background: white; border-radius: 12px; padding: 2.5rem; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
            ...
            <div
                ...
                <div style="text-align: center; margin-bottom: 2rem;">
                    <h2 style="font-size: 1.5rem; font-weight: 700; color: #B8985F; margin-bottom: 0.5rem;">Kontak dan
                        Layanan</h2>
                    <p style="color: #666; font-size: 0.95rem;">Layanan bantuan dan kontak resmi untuk pertanyaan seputar
                        peminjaman ruangan.</p>
                </div>

                {{-- Phone --}}
                <div style="margin-bottom: 1.5rem;">
                    <div style="color: #B8985F; font-weight: 600; font-size: 0.875rem; margin-bottom: 0.5rem;">Phone</div>
                ...
                {{-- Email --}}
                <div style="margin-bottom: 1.5rem;">
                    <div style="color: #B8985F; font-weight: 600; font-size: 0.875rem; margin-bottom: 0.5rem;">Email</div>
                    <div style="display: flex; align-items: center; gap: 1rem;">
                        <div
                            style="width: 40px; height: 40px; background: rgba(184, 152, 95, 0.15); border-radius: 8px; display: flex; align-items: center; justify-content: center;">
                            <svg width="20" height="20" fill="#B8985F" viewBox="0 0 24 24">
                ...
                <div style="text-align: right; margin-top: 1.5rem;">
                    <a href="{{ route('admin.contacts.edit') }}"
                        style="color: #B8985F; text-decoration: underline; font-weight: 500; font-size: 0.875rem;">
                        Edit
                    </a>
                </div>
            </div>
