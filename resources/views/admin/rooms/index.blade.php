                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <form action="{{ route('admin.rooms.destroy', $room) }}" method="POST"
                                        id="delete-room-{{ $room->id }}" style="display: inline;">
                                        @csrf
                                        @method('DELETE')
                                        <button type="button" onclick="handleDeleteRoom({{ $room->id }}, '{{ $room->name }}')"
...
@push('scripts')
    <script>
        ...
        async function handleDeleteRoom(id, name) {
            const confirmed = await confirmDelete('ruangan "' + name + '"');
            if (confirmed) {
